...
public class MemberRepositoryV1 {
    ...
    // JdbcUtils의 메소드를 사용해서 닫아준다. -> 코드가 확 짧아짐
    ...
    private Connection getConnection() throws SQLException { // 다른곳에서도 계속 사용할거기때문에(save에서만 사용하는게 아니라서) 따로 메소드로 빼냈다 -> 단축키 : command + option + M
